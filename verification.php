                ...
                <div class="col-lg-9">
                    <div class="item-wrap">
                        <div class="item item-details">
                           <h2>Check your Result Here!</h2>
                            
                            <form class="form-inline" role="form" method="post" action="validate.php">
                    <table width="100%" border="0">
  <tr>
   <td width="23%"><p style="color:#FFFFFF;">	Enter Enrollment No</p></td>
    <td width="29%"><div class="form-group"><input type="text" class="form-control input-lg" id="exampleInputEmail2" name="reg_no" placeholder="Enrollment No" style="border:solid 1px #000000;"></div></td>
    </tr>
    <tr>
    <td>&nbsp;</td>
    </tr>
    ...
    <tr>
    <td width="23%"><p style="color:#FFFFFF;">Enter Date of Birth</p></td>
    
    <td width="28%"><div class="form-group"><input type="text" class="form-control input-lg" id="exampleInputPassword2" name="dobirth" placeholder="DOB :dd/mm/yy" style="border:solid 1px #000000;"></div></td>
    <td></td>
  </tr><br><br>
   <tr>
    <td>&nbsp;</td>
   ...
   <tr>
    ...
    <button type="submit" name="submit" class="btn btn-primary">Results</button></td>
    </tr>
</table><br><br>
