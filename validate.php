                                ...
                                <nav id="mainnav" class="mainnav">
                                    <ul class="menu"> 
                                      ...
                                      <li><a href="contact.html">Contact</a></li> 
                                          <li class="active"><a href="verification.php">Student Verification</a></li>      
...
$sql = "SELECT * FROM resultz WHERE reg_no = '$reg_no' and dob = '$dobirth'";
$result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) > 0) {
    // output data of each row
	if($row = mysqli_fetch_assoc($result)) {
    echo '<div style="font-size:18px;">Registor No:&nbsp'. $row["reg_no"].'&nbsp&nbsp&nbsp&nbsp&nbsp&nbspStudent Name:&nbsp'. $row["std_name"].'&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDate Of Birth:&nbsp'. $row["dob"].'</div>';
   }
   
} else {
    echo "Registor Number or Date of Birth is Incorrect";
}
mysqli_close($conn);
?>  <br><br> 
...
if (mysqli_num_rows($result) > 0) {
	...
	while($row = mysqli_fetch_assoc($result)) {
		 ...
		 <td style='font-size:16px;'>" . $row["std_name"]. "</td>
		   </tr>";
		   echo "<tr class='info'>
		 <td style='font-size:16px;'>Father Name: </td>
		   <td style='font-size:16px;'> ". $row["father_name"]."</td>
		   </tr>";
		    echo "<tr class='info'>
         <td style='font-size:16px;'>Date of Birth: </td>
		 <td style='font-size:16px;'>" . $row["dob"]. "</td>
		   </tr>";
		    echo "<tr class='info'>
         <td style='font-size:16px;'>Course:</td>
		 <td style='font-size:16px;'>" . $row["course"]. "</td>
		   </tr>";
		   echo "<tr class='info'>
         <td style='font-size:16px;'>Sesssion: </td>
		  <td style='font-size:16px;'>" . $row["stream"]. "</td>
		   </tr>";
		    echo "<tr class='info'>
		 <td style='font-size:16px;'>Duration:</td>
		 <td style='font-size:16px;'>". $row["duration"]."</td>
		   </tr>";
          echo "<tr class='info'>
         <td style='font-size:16px;'> Enrollment No:</td>
		 <td style='font-size:16px;'> ". $row["reg_no"]."</td>
		  </tr>";
		   echo "<tr class='info'>
         <td style='font-size:16px;'>Sem I:</td>
		 <td style='font-size:16px;'>" . $row["semone"]. "</td>
		   </tr>";
		   echo "<tr class='info'>
         <td style='font-size:16px;'>Sem II: </td>
		 <td style='font-size:16px;'>" . $row["semtwo"]. "</td>
		   </tr>";
		   echo "<tr class='info'>
		 <td style='font-size:16px;'>Sem III:</td>
		 <td style='font-size:16px;'>". $row["semthree"]."</td>
		   </tr>";
		   echo "<tr class='info'>
         <td style='font-size:16px;'>Sem IV:</td>
		 <td style='font-size:16px;'>" . $row["semfour"]. "</td>
		   </tr>";
		   echo "<tr class='info'>
         <td style='font-size:16px;'>Sem V:</td>
		 <td style='font-size:16px;'>" . $row["semfive"]. "</td>
		   </tr>";
		   echo "<tr class='info'>
		 <td style='font-size:16px;'>Sem VI: </td>
		  <td style='font-size:16px;'>". $row["semsix"]."</td>
		   </tr>";
		   echo "<tr class='info'>
         <td style='font-size:16px;'>Sem VII: </td>
		 <td style='font-size:16px;'> " . $row["semseven"]. "</td>
		   </tr>";
		   echo "<tr class='info'>
         <td style='font-size:16px;'>Sem VIII: </td>
		 <td style='font-size:16px;'>" . $row["semeight"]. "</td>
      </tr>";
	  echo "<tr class='info'>
         <td style='font-size:16px;'>Percentage of Marks: </td>
		 <td style='font-size:16px;'>" . $row["percent"]. "%</td>
      </tr>";
   }
} else {
    echo "";
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="copyright"> 
                        <p>@2018 <a href="https://capehost.in">Cape Host India</a>. All rights reserved.
                        </p>
                    </div>
                </div>
